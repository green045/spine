...
'''
def tf.gather(params, indices, axis=0,name):
    return tf.stack(tf.unstack(tf.gather(tf.unstack(params, axis=axis), indices,name =name)), axis=axis)
'''
############################################################
#  Utility Functions
############################################################
...
class MaskRCNN():
    ...
    def load_weights(self, filepath, by_name=False, exclude=None):
        ...
        """
        import h5py
		#Linda edit replace topology with saving
